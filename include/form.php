...
$toemails[] = array(
				'email' => 'jonaswoa@gmail.com', // Your Email Address
				'name' => 'Jonas' // Your Name
			);
...
$fromemail = array(
				'email' => 'jonas.website@ethz.ch', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Jonas Website' // Company Name
			);
...
$recaptcha_secret = '6Lcuad8hAAAAACxx362fXa2OBHIHKkxQBXONBTdh'; // Your reCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>Jonas Website</strong>. All Rights Reserved.';
