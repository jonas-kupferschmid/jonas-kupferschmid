  ...
  jQuery.extend(!0,b,{
    ...
    startKenBurn:function(a,d,e){
      ...
      if(a.data("kbtl")&&a.data("kbtl").kill(),e=e||0,0==a.find(".tp-kbimg").length){
        ...
        m=void 0===m?"":m,
        a.append('<div class="tp-kbimg-wrap '+m+'" style="z-index:2;width:100%;height:auto;top:0px;left:0px;position:absolute;"><img class="tp-kbimg" src="'+h+'" style="position:absolute; width:100%; height:auto;"></div>'),a.data("kenburn",a.find(".tp-kbimg"))
      }
      var n=function(a,b,c,d,e,f,g){
        var h=a*c,i=b*c,j=Math.abs(d-h),k=Math.abs(e-i),
        l=new Object;
      ...
      p=function(a,b,c){
        ...
        return f[0]=f[0]>0?0:p+f[0]<a?a-p:f[0],
          ...
          h.starto.x=f[0]+"px",h.starto.y=f[1]+"px",h.endo.x=g[0]+"px",h.endo.y=g[1]+"px",
          h.end.ease=h.endo.ease=c.ease,h.end.force3D=h.endo.force3D=!0,h
      };
