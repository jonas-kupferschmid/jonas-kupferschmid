...
jQuery.extend(true,_R, {
	...
	startKenBurn :  function(l,opt,prgs) {		
		...
		if (l.find('.tp-kbimg').length==0) {
			...
			l.append('<div class="tp-kbimg-wrap '+mediafilter+'" style="z-index:2;width:100%;height:auto;top:0px;left:0px;position:absolute;"><img class="tp-kbimg" src="'+s+'" style="position:absolute;" width="100%" height="auto"></div>');
